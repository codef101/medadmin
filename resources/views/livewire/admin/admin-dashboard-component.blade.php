    ...
    <div class="container-fluid">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card mini-stat bg-primary">
                    <div class="card-body mini-stat-img">
                        ...
                        <div class="text-white">
                            <h6 class="text-uppercase mb-3 font-size-16 text-white">Airdrop Users</h6>
                            <h2 class="mb-4 text-white">10,000</h2>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Current Sales Transactions</h4>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Current List Users</h4>
